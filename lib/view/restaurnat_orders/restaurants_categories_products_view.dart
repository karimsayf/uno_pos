...
import '../../view_model/restaurant_categories_products_view_model.dart';
import '../../components/loading_indicator.dart';
import 'widgets/restaurant_product_item_card.dart';

class RestaurantsCategoriesProductsView extends StatefulWidget {
  const RestaurantsCategoriesProductsView({super.key});

  @override
  State<RestaurantsCategoriesProductsView> createState() => _RestaurantsCategoriesProductsViewState();
}

class _RestaurantsCategoriesProductsViewState extends State<RestaurantsCategoriesProductsView> {
  final controller = Get.put(RestaurantCategoriesProductsViewModel());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<RestaurantCategoriesProductsViewModel>(
        builder: (controller) {
                    ...
                    : controller.products.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return RestaurantProductItemCard(
