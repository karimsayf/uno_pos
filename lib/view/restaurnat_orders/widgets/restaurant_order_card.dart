...
class RestaurantOrderCard extends StatefulWidget {
  final RestaurantOrder orderModel;
  const RestaurantOrderCard({super.key,required this.orderModel,});
...
class _RestaurantOrderCardState extends State<RestaurantOrderCard> {
  final RestaurantsOrdersViewModel ordersViewModel = Get.find<RestaurantsOrdersViewModel>();
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                 "${DateFormat('EEEE، d MMMM y h:mm a', 'ar').format(widget.orderModel.createdAt!)}",
                style: TextStyle(
                  fontSize: 16,
          ...
          Row(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.network(
                  ServerUrls.filesBaseUrl +widget.orderModel.restaurantLogo,
                  height: 80,
                  width: 80,
                  fit: BoxFit.cover,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTitle(
                      text: "رقم الطلب: ${widget.orderModel.orderNum}",
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                      color: colorCAC,
                    ),
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10,),
                    Text(widget.orderModel.notes!.isNotEmpty? widget.orderModel.notes! : 'لا توجد ملاحظات'),
                  ],
                ),
              ],
            ),
  ...
  orderChoice(CartMealModel item) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          ClipRRect(
            borderRadius: BorderRadius.circular(13),
            child: Image.network(
              ServerUrls.filesBaseUrl +item.itemImage,
              height: 50,
              width: 50,
              fit: BoxFit.cover,
              errorBuilder: (context, error, stackTrace) => SizedBox(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    CustomTitle(
                      text: "${item.lineTotal} ${Constants.appCurrency}",
                      fontSize: 16,
                      fontWeight: FontWeight.w500,
                      color: colorCAC,
                    ),
