...
import 'restaurants_categories_products_view.dart';
...
class RestaurantOrders extends StatefulWidget {
  ...
  @override
  State<RestaurantOrders> createState() => _RestaurantOrdersState();
}

class _RestaurantOrdersState extends State<RestaurantOrders> {
  final controller = Get.put(RestaurantsOrdersViewModel());
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final ScrollController _scrollController = ScrollController();

  @override
  void initState() {
    controller.getRestaurantStatus();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: GetBuilder<RestaurantsOrdersViewModel>(
          builder: (controller) => Row(
            children: [
              ...
              Text('طلبات المطعم',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 20),),
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Get.back();
                Get.to(() => const RestaurantsCategoriesProductsView());
              },
            ),
            const Divider(),
            const Spacer(),
      ...
      body: GetBuilder<RestaurantsOrdersViewModel>(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                ...controller.orders.map((order) => RestaurantOrderCard(orderModel: order,)),
